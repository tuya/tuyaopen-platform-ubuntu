...
OPERATE_RET tkl_timer_init(TUYA_TIMER_NUM_E timer_id, TUYA_TIMER_BASE_CFG_T *cfg)
{
    ...
    if ((2 == timer_id) || (3 == timer_id)) {//bk timer2��3 ��ϵͳռ����ʵ�� bk timerID Ϊ timer4~timer5
        timer_id +=2;
    }
...
OPERATE_RET tkl_timer_start(TUYA_TIMER_NUM_E timer_id, uint32_t us)
{
    ...
    if ((0 == timer_id) || (1 == timer_id)) {
        ...
        bk_timer_initialize((timer_id + 2), us / 1000, __tkl_hw_timer_cb); //bk timer2��3 ��ϵͳռ����ʵ�� bk timerID Ϊ timer4~timer5
        return OPRT_OK;
    }
...
OPERATE_RET tkl_timer_stop(TUYA_TIMER_NUM_E timer_id)
{
    ...
    if ((0 == timer_id) || (1 == timer_id)) {
        ...
        bk_timer_stop(timer_id + 2); //bk timer2��3 ��ϵͳռ����ʵ�� bk timerID Ϊ timer4~timer5
        return OPRT_OK;
    }
